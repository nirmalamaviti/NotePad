...
function addTask(date, time, textValue, id, order){
    ...
    textField.innerHTML = `<div class="datentime"><span class="date">${date}</span><span class="time">${time}</span><span class="fa fa-star checked" id="-${id}" onclick="markAsImp(this.id)"></span><span><img src="https://cdn-icons-png.freepik.com/512/3601/3601242.png" class="buttonOnDOM" id="e${id}" onclick="edit(this.id)"></span></div><div class="task" id="task${id}">${textValue}<img src="https://cdn-icons-png.freepik.com/512/6861/6861362.png" id="${id}" class="delete" onclick="deleteTask(this.id)"></div>`;
